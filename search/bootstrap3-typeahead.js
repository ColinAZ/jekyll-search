!function(a, b) {
    "use strict";
    "undefined" != typeof module && module.exports ? module.exports = b(require("jquery")) : "function" == typeof define && define.amd ? define(["jquery"],
    function(a) {
        return b(a)
    }) : b(a.jQuery)
} (this,
function(a) {
    ...
    a.fn.typeahead.defaults = {
        source: [],
        items: 20, //搜索结果显示条数
        menu: '<ul class="typeahead dropdown-menu search-menu" role="listbox"></ul>',
